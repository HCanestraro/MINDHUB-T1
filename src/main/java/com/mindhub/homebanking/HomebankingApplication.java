...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(CardRepository cardRepository, ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository) {
		return (args) -> {
			...
			transactionRepository.save(new Transaction(1000.00, LocalDateTime.now(), "Account deposit", accMelba1, TransactionType.CREDIT));
			accMelba1.setBalance(accMelba1.getBalance() + 1000);
			accountRepository.save(accMelba1);
			transactionRepository.save(new Transaction(-1000.00, LocalDateTime.now(), "Account maintain", accMelba1, TransactionType.DEBIT));
			accMelba1.setBalance(accMelba1.getBalance() -1000);
			accountRepository.save(accMelba1);
			transactionRepository.save(new Transaction(-1250.00, LocalDateTime.now(), "Services payments", accMelba1, TransactionType.DEBIT));
			accMelba1.setBalance(accMelba1.getBalance() -1250);
			accountRepository.save(accMelba1);
			transactionRepository.save(new Transaction(500.00, LocalDateTime.now(), "Transfer received", accMelba1, TransactionType.CREDIT));
			accMelba1.setBalance(accMelba1.getBalance() + 500);
			accountRepository.save(accMelba1);
			transactionRepository.save(new Transaction(-2000.00, LocalDateTime.now(), "Card payment", accMelba2, TransactionType.DEBIT));
			accMelba2.setBalance(accMelba2.getBalance() -2000);
			accountRepository.save(accMelba2);
			transactionRepository.save(new Transaction(-900.00, LocalDateTime.now(), "Account maintain", accMelba2, TransactionType.DEBIT));
			accMelba2.setBalance(accMelba2.getBalance() -900);
			accountRepository.save(accMelba2);
			transactionRepository.save(new Transaction(-850.00, LocalDateTime.now(), "Services payments", accMelba2, TransactionType.DEBIT));
			accMelba2.setBalance(accMelba2.getBalance() - 850);
			accountRepository.save(accMelba2);
			transactionRepository.save(new Transaction(1000.00, LocalDateTime.now(), "Transfer received", accMelba2, TransactionType.CREDIT));
			accMelba2.setBalance(accMelba2.getBalance() + 1000);
			accountRepository.save(accMelba2);
			transactionRepository.save(new Transaction(-2000.00, LocalDateTime.now(), "Services payments", accPablo1, TransactionType.DEBIT));
			accPablo1.setBalance(accPablo1.getBalance() - 2000);
			accountRepository.save(accPablo1);
			transactionRepository.save(new Transaction(300000.00, LocalDateTime.now(), "Incoming", accPablo1, TransactionType.CREDIT));
